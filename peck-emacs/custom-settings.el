...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (web-mode which-key omnisharp csharp-mode ac-php-core alert dash dash-functional ghub git-commit helm-core ivy ace-popup-menu rainbow-mode evil-surround expand-region cmake-mode helm-xref org smartparens virtualenvwrapper markdown-mode try exec-path-from-shell projectile evil helm js2-mode company airline-themes powerline all-the-icons-dired company-irony-c-headers flycheck-irony flycheck company-irony ace-window ecb neotree chinese-wbim ag ace-isearch rjsx-mode youdao-dictionary xref-js2 use-package swift-mode sourcemap skewer-mode shackle python-environment org-pomodoro org-bullets nodejs-repl mew magit json-mode js2-refactor indium helm-swoop helm-projectile helm-gtags helm-flyspell helm-ag gorepl-mode gore-mode go-autocomplete ggtags erlang emmet-mode elpy doom-themes concurrent composer company-tern company-php company-lua company-go column-enforce-mode benchmark-init ace-jump-mode ac-php)))
